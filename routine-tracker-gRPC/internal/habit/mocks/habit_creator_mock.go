...
//go:generate minimock -i github.com/itsfarhan/routine-tracker/internal/habit.habitCreator -o habit_creator_mock.go -n HabitCreatorMock -p mocks
...
import (
	...
	mm_habit "github.com/itsfarhan/routine-tracker/internal/habit"
)
